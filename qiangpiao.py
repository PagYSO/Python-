...
def Init():
    ...
    TargetTime = "2024-10-27 21:41:00.00000000"  # 设置抢购时间
    WangZhi = "https://show.bilibili.com/platform/detail.html?id=93269&pc_mall"  # 设置抢票网址
    Session = '3'  # 场次设置：修改引号内部的数字，数字对应第选项的序号，选项序号从左到右从1开始依次排列
    Price = '2'  # 价格设置：设置方法与场次设置一样
    Number = 1  # 票数设置，注意不要超过限制 #另外，如果是实名制购票的话要先在会员购中心-购买人信息添加好
    chrome_driver_path = "C:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe"  # 指定Chromedriver的路径
